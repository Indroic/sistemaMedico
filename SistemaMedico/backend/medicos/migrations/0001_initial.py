    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', django_resized.forms.ResizedImageField(blank=True, crop=['middle', 'center'], db_column='medic_image', force_format=None, keep_meta=True, null=True, quality=-1, scale=None, size=[736, 736], upload_to=medicos.models.generar_nombre, verbose_name='Foto de Medico')),
                ...
                ('especialidad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicos.especialidad', verbose_name='Especialidad')),
            ],
            options={
                'verbose_name': 'Medico',
